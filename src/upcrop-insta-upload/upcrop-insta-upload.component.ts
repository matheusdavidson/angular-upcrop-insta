...
@Component({
    ...
    templateUrl: './upcrop-insta-upload.component.html',
    styleUrls: ['./upcrop-insta-upload.component.scss'],
...
export class UpcropInstaUploadComponent implements OnInit {
    ...
    onSelectInstagramPictureProxy($event) {
        this.onSelectInstagramPicture.emit($event);
    }

    onUnselectInstagramPictureProxy($event) {
