(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/http'), require('@angular/material'), require('rxjs/add/operator/toPromise'), require('lodash'), require('@angular/flex-layout'), require('angular-cropperjs')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/http', '@angular/material', 'rxjs/add/operator/toPromise', 'lodash', '@angular/flex-layout', 'angular-cropperjs'], factory) :
	(factory((global['angular-upcrop-insta'] = {}),global.core,global.common,global.http,global.material,null,global._,global.flexLayout,global.angularCropperjs));
}(this, (function (exports,core,common,http,material,toPromise,_,flexLayout,angularCropperjs) { 'use strict';
...
var UpcropInstaUploadComponent = (function () {
    function UpcropInstaUploadComponent() {
        ...
        this.onSelectInstagramPicture = new core.EventEmitter();
        this.onUnselectInstagramPicture = new core.EventEmitter();
    }
    /**
     * @return {?}
     */
...
UpcropInstaUploadComponent.propDecorators = {
    ...
    'onSelectInstagramPicture': [{ type: core.Output },],
    'onUnselectInstagramPicture': [{ type: core.Output },],
};
...
var UpcropInstaUploadService = (function () {
    ...
    UpcropInstaUploadService.prototype.upload = function (url, file) {
        ...
        var /** @type {?} */ headers = new http.Headers(headersContent);
        var /** @type {?} */ options = new http.RequestOptions({ headers: headers });
...
var UpcropInstaDialogComponent = (function () {
    ...
    UpcropInstaDialogComponent.prototype.onUnselectInstagramPicture = function (event) {
        ...
        _.remove(this.selectedInstagramPictures, function (o) {
...
var UpcropInstaService = (function () {
    ...
    UpcropInstaService.prototype.getInstagramImages = function (accessToken, count, maxId) {
        ...
        // 
        // Add headers
        var /** @type {?} */ headers = new http.Headers({ 'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8' });
...
UpcropInstaSelectImagesComponent.decorators = [
    { type: core.Component, args: [{
                ...
                template: "<!-- MAIN LOAD --> <div main-loading [fxHide]=\"!load || instagramImages.length\"> <div class=\"spinner\"></div> </div> <!-- NO ENTRIES --> <div no-entries [fxHide]=\"load || instagramImages.length\"> <div no-entries-content> <mat-icon>texture</mat-icon> <h1 class=\"mat-title\">Nenhuma imagem</h1> <h2 class=\"mat-subhead\">Nenhuma imagem para exibir no momento</h2> </div> </div> <!-- IMAGES --> <div class=\"images-list-items-container\" fxLayout=\"column\" fxLayout.gt-xs=\"row\" fxLayoutGap=\"16px\" fxLayoutWrap=\"none\" fxLayoutWrap.gt-xs> <mat-card class=\"images-list-item\" [ngClass]=\"{'selected': item.selected}\" fxFlex=\"0 0 none\" fxFlex.gt-xs=\"0 0 calc(33.3333% - 16px)\" *ngFor=\"let item of instagramImages\"> <div class=\"card-background-image\" [style.backgroundImage]=\"'url('+ item.images.low_resolution.url +')'\"></div> <mat-card-content> <p truncate>{{item.name}}</p> </mat-card-content> <mat-card-footer fxLayout> <button mat-button fxFlex [fxHide]=\"item.selected\" (click)=\"selectPicture(item)\"> <mat-icon>check_box_outline_blank</mat-icon> Selecionar </button> <button class=\"has-text-success\" mat-button fxFlex [fxHide]=\"!item.selected\" (click)=\"unselectPicture(item)\"> <mat-icon>check</mat-icon> Selecionado </button> </mat-card-footer> </mat-card> </div> <!-- LOAD MORE --> <div class=\"full-width\" [hidden]=\"nextPageId == false\"> <button class=\"full-width\" mat-raised-button color=\"primary\" [ngClass]=\"{'is-loading': load}\" (click)=\"getInstagramImages()\">Carregar mais imagens</button> </div>",
                styles: [".full-width { width: 100%; } [main-loading] { min-height: 120px; padding-top: 34px; box-sizing: border-box; flex-direction: column; max-width: 100%; place-content: center; align-items: center; display: flex; } .upcrop-insta-upload-container { width: 100%; padding: 16px 0; } mat-card-footer { border-top: 1px solid rgba(0, 0, 0, 0.1); } mat-card-footer button { padding: 8px 0; } .images-list-items-container { margin-right: -16px; } @media (max-width: 599px) { .images-list-items-container { margin-right: 0px; } } .images-list-items-container [mat-card-image] { cursor: pointer; } .images-list-item { opacity: .5; margin-bottom: 16px; } .images-list-item.selected { opacity: 1; } .card-background-image { min-width: 100%; height: 180px; margin: -24px -24px -16px; background-size: cover; background-repeat: no-repeat; background-position: center center; } @media (max-width: 600px) { .card-background-image { margin: -24px -16px -16px -16px; } } .mat-raised-button.is-loading:after { -webkit-animation: spinAround 500ms infinite linear; animation: spinAround 500ms infinite linear; border: 2px solid rgba(255, 255, 255, 0.7); border-radius: 50%; border-right-color: transparent; border-top-color: transparent; content: \"\"; display: block; height: 20px; position: relative; width: 20px; position: absolute; left: calc(50% - (20px / 2)); top: calc(50% - (20px / 2)); position: absolute !important; } .mat-raised-button.is-loading .mat-button-wrapper { visibility: hidden; } "],
...
UpcropInstaCropComponent.propDecorators = {
    ...
    'config': [{ type: core.Input },],
    'selectedInstagramPictures': [{ type: core.Input },],
...
exports.UpcropInstaUploadComponent = UpcropInstaUploadComponent;
exports.UpcropInstaSelectImagesComponent = UpcropInstaSelectImagesComponent;
exports.UpcropInstaCropComponent = UpcropInstaCropComponent;
exports.UpcropInstaDialogComponent = UpcropInstaDialogComponent;
exports.UpcropInstaService = UpcropInstaService;
exports.UpcropInstaUploadService = UpcropInstaUploadService;
